...
import RRestaurantList from './RRestaurantList.jsx'
import CafeList from './CafeList.jsx'
import './PartnerList.css' // CSS 파일 경로 수정
const PartnerList = (props) => {
    // 드롭다운
    let [view, setView] = useState(false)
    let [sortOption, setSortOption] = useState('거리순');
    ...
    return (
        <>
            <div className='map_box'>
                ...
                <div className='map_list' style={{ width: '30%', overflowY: 'scroll' }}>
                    <div className='map_list_search'>
                        <div className='map_list_sort'>
                            ...
                            >
                                <li>{view ? sortOption + ' ^' : sortOption + ' ⌄'}</li>
                                {view &&
                                    dropData.map((option) => (
                    ...
                    <div className='map_list_restaurant'>
                        <RRestaurantList data={filter} />
                        <CafeList data={filter} />
                    </div>
                </div>
            </div>
        </>
